...
def index_admin(request):
    ...
    totaldelivereddonations= Donation.objects.filter(status="delivered").count()
...
def donationdelivered_admin(request):
    if not request.user.is_authenticated:
        return redirect('/login-admin')
    donation=Donation.objects.filter(status='delivered')
...
def index_donor(request):
    ...
    acceptedcount = Donation.objects.filter(donor=donor, status='accepted').count()
    ...
    deliverycount = Donation.objects.filter(donor=donor, status='delivered').count()
...
def index_volunteer(request):
    ...
    totalCollectionReq = Donation.objects.filter(volunteer=volunteer,status="pending").count()
    totalRecDonation= Donation.objects.filter(volunteer=volunteer,status="accepted").count()
    totalNotRecDonation= Donation.objects.filter(volunteer=volunteer,status="rejected").count()
    totalDonationDelivered= Donation.objects.filter(volunteer=volunteer,status="delivered").count()
...
def collection_req(request):
    ...
    user = request.user
    volunteer = Volunteer.objects.get(user=user)
    donation = Donation.objects.filter(volunteer=volunteer,status="pending")
...
def donationrec_volunteer(request):
    ...
    user = request.user
    volunteer = Volunteer.objects.get(user=user)
    donation = Donation.objects.filter(volunteer=volunteer,status="accepted")
...
def donationnotrec_volunteer(request):
    ...
    user = request.user
    volunteer = Volunteer.objects.get(user=user)
    donation = Donation.objects.filter(volunteer=volunteer,status="rejected")
...
def donationdelivered_volunteer(request):
    ...
    user = request.user
    volunteer = Volunteer.objects.get(user=user)
    donation = Donation.objects.filter(volunteer=volunteer,status="delivered")
